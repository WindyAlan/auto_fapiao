...
- **rename.py** — PDF classification (Type 1: `2100002601080A_xxx.pdf`, Type 2: `dzfp_xxx.pdf`) and batch rename.
- **verify.py** — Excel vs OCR comparison (columns AF/BZ/CA/CB/CC/CD, rows 4+). Auto-fixes high-confidence (>0.8) mismatches.
